---
title: "Figure 4A: Enrichment of protein-ligand interactions"
output:
  github_document:
    toc: true
    toc_depth: 2
...
```{r Are BioLiP interactions associated with conservation plane class?}
# Chi-square test
chi <- chisq.test(avs_xclass_summary[, c("PDB_biolip", "PDB_sequences_with_contacts")])
chi
```
## Odds ratios for BioLiP enrichment in X-Classes
...
## Odds ratios for protein-ligand interaction enrichment in X-Class * RSA
